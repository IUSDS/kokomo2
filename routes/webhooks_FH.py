...
get_points_cost_from_booking_fh,get_points_from_members,new_record_in_point_adjustment
...
#######################
    ...
    print('yacht_name',yacht_name)
########################



    if if_booking_exists(booking_pk) and status=='cancelled':
        result=get_points_cost_from_booking_fh(booking_pk)
        print('////points_cost',result['points_cost'])
        print('////member_id',result['member_id'])
        curr_points=get_points_from_members(result['member_id'])
        print('\\\\\\curr_points',curr_points['points'])
        updated_points=result['points_cost']+curr_points['points']
        print('????updated_points',updated_points)
        ss=new_record_in_point_adjustment(result['member_id'],points_added=result['points_cost'],Balance=updated_points,description=yacht_name)
        print('++++',ss)
